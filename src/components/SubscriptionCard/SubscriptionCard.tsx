...
import SubscriptionCardBox from "../SubscriptionCardBox/SubscriptionCardBox";
...
<div
  className={[
    "mx-auto flex max-w-[1400px] flex-wrap justify-center gap-5",
    showHeader ? "mt-8" : "mt-2",
  ].join(" ")}
>
  <button
    type="button"
    className="w-[300px] rounded-3xl text-left focus:outline-none focus:ring-2 focus:ring-[#3B5BFF]"
  >
    <SubscriptionCardBox 
    title="Standard Package" 
    descriptions="Ideal for members who want to explore and stay informed." 
    price={12} 
    bullets={["View company information", 
      "Access offers from funds, banks, and financial institutions (view only)",
    ]} 
    active={false} />
  </button>
  <button
  ...
  >
    <SubscriptionCardBox
     title="Gold Package"
      descriptions="Perfect for active members seeking comprehensive access and engagement."
      price={29}
      bullets={["View company information", 
      "Access offers from funds, banks, and financial institutions (view only)",
      "Access to use offers",
      "Access to tenders"
    ]} 
    active={true} />
  </button>
  ...
  >
    ...
    descriptions="Best for power users who want full access and premium features." 
    price={49} 
    bullets={["View company information", 
      "Access offers from funds, banks, and financial institutions (view only)",
      "Access to use offers",
